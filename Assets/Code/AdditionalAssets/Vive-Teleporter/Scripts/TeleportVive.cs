...
public class TeleportVive : MonoBehaviour {
    ...
    public bool[] canControllerTeleport;
    ...
    public bool PlayerInTheRoom {
        get
        {
            if (ApplicationStaticData.roomToConnectName != ApplicationStaticData.worldRoomName) return true;
            else return false;
        }
    }
    ...
    void Start()
    {
        ...
        canControllerTeleport = new bool[2] { true, true};
    }
